...
import MedicalModalCard from "../Medical/MedicalModalCard";

const MoveAnimalSearch = () => {
  ...
  useEffect(() => {
    ...
    getSection(postData)
      .then((res) => {
        ...
        // console.log('THIS IS THE SECTION DATA===========+++++=: ', res.data);
      })
      .catch((error) => {
        console.log(error);
      })
  ...
  //   useEffect(() => {
  //     modalSearchValue(searchModalText);
  //   }, [searchModalText]);

  //   const modalSearchValue = (query) => {
  //     console.log(query);
  //     let obje = {
  //       zoo_id: zooID,
  //       parent_tsn: 177785,
  ...
  //     searchAnimal(obje)
  //       .then((res) => {
  //         console.log("this is modal List Data", res);
  //         setSelectAnimalData(res.data)
  //       })
  //       .catch((err) => {
  //         console.log(err);
  //       })
  ...
  const gotoSeacrhScreen = () => {
    ...
    navigation.navigate("SearchedState", routeData);
  };
  ...
  return (
    <>
      ...
      <View style={styles.container}>
        ...
        {sectionType === "" || selectEnclosure === "" || animalType === "" ?  null :(
...
export default MoveAnimalSearch;
