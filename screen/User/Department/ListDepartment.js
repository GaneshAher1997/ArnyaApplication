...
import { deleteUserDepartment, getUserDepartment } from '../../../services/UserDepartmentService';
...
const ListDepartment = () => {
    ...
    const deleteDept = (item) => {
        ...
        deleteUserDepartment(obj).then((res) => {
            if (!res.success) {
...

                {
                    isLoading || refreshing ? <Loader /> :
                        <View style={styles.container}>
                            <FlatList
                                data={userDept}
                                renderItem={item => <ListComponent item={item} onPressEdit={editDept} onPressDelete={deleteDept} onPress={() => navigation.navigate('GetuserDept', { itemId: item.item.id })} >
                                    <InnerList item={item} />
                                </ListComponent>}
