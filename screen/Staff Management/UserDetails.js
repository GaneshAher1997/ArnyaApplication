    ...
    return (
        <>
            ...
            <View style={[styles.container,{ backgroundColor: isSwitchOn ? "#1F415B" : "#DAE7DF" }]}>
                    ...
                    <View>
                        <View style={styles.innerContainer}>
                            <View style={styles.row}>
                                <Text style={{ marginHorizontal: 5 ,color : isSwitchOn ? "white" : "black"}}>
                                    Name :
                                </Text>
                                <Text style={{color : isSwitchOn ? "white" : "black"}}>{data.user_first_name} {data.user_last_name}</Text>
                            </View>
                            <View style={styles.row}>
                                <Text style={{ marginHorizontal: 5 ,color : isSwitchOn ? "white" : "black"}}>
                                    Email :
                                </Text>
                                <Text style={{color : isSwitchOn ? "white" : "black"}}>{data.user_email}</Text>
                            </View>
                            <View style={styles.row}>
                                <Text style={{ marginHorizontal: 5 ,color : isSwitchOn ? "white" : "black"}}>
                                    Mobile :
                                </Text>
                                <Text style={{color : isSwitchOn ? "white" : "black"}}>{data.user_mobile_number}</Text>
                            </View>
                ...
                >
                    <Text style={[styles.buttonText,{color : isSwitchOn ? "white" : "black"}]}>
                        Personal Details
                    </Text>
                    <AntDesign name="right" size={20} color={isSwitchOn ? "white" : "black"} />
                </TouchableOpacity>
                <TouchableOpacity
                    style={styles.buttonContainer}
                    onPress={() => {
