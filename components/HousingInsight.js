...
const HousingInsight = ({ title, insightData, ...props }) => {
  // console.log("THIS IS INSIGHT DATA======", insightData)

  // const [insightdata, setInsightdata] = useState(insightData)
  // console.log("THIS STATE SAVE DATA=========", insightdata)
  ...
  const Item = ({ item, onPress }) => {
    return (
      <View>
        {item.type === "icon" ? (
          <TouchableOpacity onPress={onPress}>{item.icon}</TouchableOpacity>
        ) : (
          <TouchableOpacity
            onPress={onPress}
            style={[
    ...
    >
      ...
      >
        ...
        <View style={styles.parent}>
          ...
          <Text style={styles.textStyle}>Enclosure</Text>
        </View>
